            ...
            <div class="card-body">
                <div class="py-2 d-flex justify-content-between">
                    <div class="dflex justify-content-between">
                        ...
                        <a href="" class="btn btn-secondary text-white">DRAFTING</a>
                        <a href="" class="btn btn-secondary text-white">VETTING</a>
                        <a href="" class="btn btn-secondary text-white">LEGAL OPINION</a>
                        <a href="" class="btn btn-secondary text-white">LEGAL CONSULTATION</a>
                        <a href="" class="btn btn-secondary text-white">LEGAL NOTICE/REPLY</a>
                        <a href="" class="btn btn-secondary text-white">SEARCHING & INQUIRY</a>
                        <a href="" class="btn btn-secondary text-white">AFFIDAVID & NOTARY</a>
                    </div>
                    <a href="{{ route('lawyer.legalservice.create') }}" class="btn btn-info text-white">ADD</a>
                </div>
