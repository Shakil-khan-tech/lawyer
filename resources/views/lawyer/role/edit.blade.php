    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header bg-white py-3">
                <div class="row">
                    <div class="col-3">
                        <h3 class="mb-2 font-weight-bold" style="color: black;">Edit Role</h3>
                    </div>
                    <div class="col-9">
                    </div>
                </div>
            ...
            <div class="card-body">
            	...
            	<div class="case-info-section section">
                   <div class="row pb-3">
                       <div class="col-md-12">
                        <form action="{{ route('lawyer.role.update', $role->id) }}" method="POST">
                            @csrf
                           <div class="form-group row px-5">
                            {{-- <input type="hidden" name="lawyer_id" value="{{ auth()->guard('lawyer')->id() }}"> --}}
                               ...
                               <input type="text" required class="form-control" name="name" value="{{ $role->name }}" placeholder="eg: Editor">
                           </div>
