    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header-report py-3">
                <div class="d-flex header-main pb-2">
                    <h3>Custom Report</h3>
            ...
            <div class="case-info-section section">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="case_category_id" class="col-form-label font-weight-bold text-info col-md-4">Case Class</label>
                            <div class="col-md-8">
                                <select name="" class="form-control select2">
                                    <option selected disabled hidden>Select</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="" class="col-form-label font-weight-bold text-info col-md-4">Report Type</label>
                            <div class="col-md-8">
                                <select name="" class="form-control select2">
                                    <option selected disabled hidden>Select</option>
    ...
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between">
                <h4 class="m-0 font-weight-bold"><i class="fa fa-users text-primary"></i> Case Report</h4>
            </div>
            <div class="card-body">
...
scrollY: '85vh',
  // scrollCollapse: true,
ajax: "{{ route('lawyer.litigation.report') }}",
columns: [
  {data: 'id', name: 'id'},
  {data: 'tppe', name: 'tppe'},
  {data: 'next date', name: 'next date'},
  {data: 'fixed for', name: 'fixed for'},
  {data: 'court', name: 'court'},
  {data: 'case no', name: 'case no'},
  {data: 'police station', name: 'police station'},
  {data: '1st party', name: '1st party'},
  {data: '2nd party', name: '2nd party'},
  {data: 'nature', name: 'nature'},
  {data: 'matter', name: 'matter'},
  {
      data: 'action', 
      name: 'action', 
      orderable: false, 
